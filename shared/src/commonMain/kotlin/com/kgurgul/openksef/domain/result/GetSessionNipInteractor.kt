...
/** Returns the NIP of the currently authenticated session, or `null` when logged out. */
class GetSessionNipInteractor(
    ...
    override suspend fun doWork(params: Unit): String? = sessionHolder.nip
}
