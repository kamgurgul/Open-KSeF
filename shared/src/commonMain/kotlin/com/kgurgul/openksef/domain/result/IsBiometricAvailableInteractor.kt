...
/** Tells whether the device can run the biometric check (false on desktop). */
class IsBiometricAvailableInteractor(
    ...
    override suspend fun doWork(params: Unit): Boolean = biometricAuthenticator.isAvailable()
}
