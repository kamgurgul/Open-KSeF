...
/** Emits whenever the KSeF session expires and the user has to log in again. */
class SessionExpiredObservable(
    dispatchersProvider: IDispatchersProvider,
    private val sessionEventBus: SessionEventBus,
) : ImmutableInteractor<Unit, Unit>() {

    override val dispatcher = dispatchersProvider.io

    override fun createObservable(params: Unit): Flow<Unit> = sessionEventBus.sessionExpired
}
