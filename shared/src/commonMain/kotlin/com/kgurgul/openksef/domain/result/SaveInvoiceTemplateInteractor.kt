...
/** Inserts a new invoice template or replaces an existing one with the same id. */
class SaveInvoiceTemplateInteractor(
    dispatchersProvider: IDispatchersProvider,
    private val invoiceTemplateRepository: InvoiceTemplateRepository,
) : ResultInteractor<InvoiceTemplate, Unit>() {

    override val dispatcher = dispatchersProvider.io

    override suspend fun doWork(params: InvoiceTemplate) {
        invoiceTemplateRepository.save(params)
    }
}
