...
/** Saves the login credentials when the user opted in, or wipes them otherwise. */
class PersistCredentialsInteractor(
    dispatchersProvider: IDispatchersProvider,
    private val tokenStore: TokenStore,
) : ResultInteractor<PersistCredentialsInteractor.Params, Unit>() {
